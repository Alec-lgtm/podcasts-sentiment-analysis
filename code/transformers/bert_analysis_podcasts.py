...
# Load data
df = pd.read_csv('../../data/vox_podcasts/podcasts_transcripts_clean.csv')
...
df.to_csv('../../data/bert_labels/vox_podcast_with_sentiment.csv', index=False)
print("Done! Results saved to 'vox_podcast_with_sentiment.csv'")
