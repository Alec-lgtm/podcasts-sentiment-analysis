...
transcript <- readtext("C:\\Users\\ak_wa\\OneDrive\\Documents\\Data Sci\\course_projects\\podcasts-sentiment-analysis\\data\\vox_podcasts\\2021\\6_29_21_ Canada_s residential schools.docx")

files <- list.files(path = "C:\\Users\\ak_wa\\OneDrive\\Documents\\Data Sci\\course_projects\\podcasts-sentiment-analysis\\data\\vox_podcasts", full.names = T, recursive = T)
transcript <- readtext(files)

# files <- list.files(path = "/data/vox_podcasts", full.names = T, recursive = T)
# # Load the transcript file
# transcript <- readtext(files, docvarsfrom = "filepaths", dvsep = "/", verbosity = 3, ignore_missing_files = TRUE)
