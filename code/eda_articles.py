...
def create_visualizations(combined_counts, output_dir="output"):
    ...
    plt.savefig(Path(output_dir) / 'wordcloud.png', bbox_inches='tight', dpi=300)
    plt.close()
    ...
    plt.savefig(Path(output_dir).resolve() / 'top_words.png', bbox_inches='tight', dpi=300)
    plt.close()

def main():
    # Set up configuration
    csv_file = "vox_articles.csv"
    output_dir = "../figures"
