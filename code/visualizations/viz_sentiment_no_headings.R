...
article_worst <- visualize_podcast_sentiment(worst_sentiment_article_value,  window_size = 10)
podcast_worst <- visualize_podcast_sentiment(worst_sentiment_podcast_value, window_size = 10)
article_best <- visualize_podcast_sentiment(best_sentiment_article_value, window_size = 10)
podcast_best <- visualize_podcast_sentiment(best_sentiment_podcast_value, window_size = 10)
