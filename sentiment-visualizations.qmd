...
the breadth and depth of Vox's catalog of articles and podcasts, we decided to focus on two main areas  in the comparison between Vox podcasts and articles.
...
We can however provide metrics on distribution of words used in the Vox podcasts.

![](..\blog\vox_articles_top_words)
